...
const SearhTeamsInp = () => {
    return (
        <div className='flex justify-center m-5 mb-10'>
            ...
            <input type="input" list='heroes' name="search" id="search" placeholder='Search Teams' className=' border-box w-2/3 rounded border-2 border-solid  p-2 outline-none focus:border-green-500  focus:transition-all lg:w-1/3 '/>
            <datalist id='heroes'>
